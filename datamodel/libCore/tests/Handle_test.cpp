...
TEST(HandleTests, Node)
{
	...
	std::vector<std::string> refPropNames{"objectID", "objectName", "children", "userTags", "metaData", "tags", "visibility", "enabled", "translation", "rotation", "scaling", "editorVisibility"};
